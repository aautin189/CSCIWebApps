/*  
ACCESSING input area of our html file
*/
...
/*
Now listening for events triggered by user
*/
...
function buttonEvent(){
	let number = guess.toString();	//returns concatenated value
	guessNumber(number);	//sends that value to guessNumber() function
}
